...
Date: 2026-04-15T16:41:28.744780+00:00
...
| --- | --- | --- | --- | --- | --- |
| `langgraph` | `30/30` | `25/30` | `93.8` | `6324.9 ms` | `0/30` |
| `python_functions` | `27/30` | `23/30` | `85.7` | `5531.6 ms` | `0/30` |
| `llamaindex` | `27/30` | `23/30` | `85.7` | `5832.1 ms` | `5/30` |
| `specialist_supervisor` | `30/30` | `28/30` | `98.7` | `1884.9 ms` | `0/30` |

## By Slice

- `protected`
  - `langgraph`: ok 13/13, keyword pass 9/13, quality 88.2, latency 6756.0ms, final polish 0/13
  - `python_functions`: ok 10/13, keyword pass 7/13, quality 68.5, latency 3757.2ms, final polish 0/13
  - `llamaindex`: ok 10/13, keyword pass 8/13, quality 70.1, latency 3350.3ms, final polish 0/13
  - `specialist_supervisor`: ok 13/13, keyword pass 11/13, quality 96.9, latency 278.1ms, final polish 0/13
- `public`
  - `langgraph`: ok 11/11, keyword pass 10/11, quality 97.1, latency 7155.2ms, final polish 0/11
  - `python_functions`: ok 11/11, keyword pass 10/11, quality 98.2, latency 8486.3ms, final polish 0/11
  - `llamaindex`: ok 11/11, keyword pass 9/11, quality 96.4, latency 9557.8ms, final polish 5/11
  - `specialist_supervisor`: ok 11/11, keyword pass 11/11, quality 100.0, latency 4432.8ms, final polish 0/11
- `restricted`
  - `langgraph`: ok 6/6, keyword pass 6/6, quality 100.0, latency 3868.5ms, final polish 0/6
  - `python_functions`: ok 6/6, keyword pass 6/6, quality 100.0, latency 3959.1ms, final polish 0/6
  - `llamaindex`: ok 6/6, keyword pass 6/6, quality 100.0, latency 4379.1ms, final polish 0/6
  - `specialist_supervisor`: ok 6/6, keyword pass 6/6, quality 100.0, latency 694.9ms, final polish 0/6

## Error Types

- `langgraph`: attendance_metric_misroute=1, forbidden_entity_or_value=1, missing_expected_keyword=4, unnecessary_clarification=3
- `python_functions`: attendance_metric_misroute=1, forbidden_entity_or_value=1, missing_expected_keyword=3, request_failed=3
- `llamaindex`: attendance_metric_misroute=1, forbidden_entity_or_value=1, missing_expected_keyword=3, request_failed=3
...
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_student_academic_self:python_functions
ingress: unknown:none
...
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_student_academic_self:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_docs_credentials:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_docs_credentials:python_functions
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_docs_credentials:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_staff_finance_protocol:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_staff_finance_protocol:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_staff_finance_protocol:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_staff_finance_protocol:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_denied:langgraph
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_denied:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_denied:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_governance_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_governance_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_governance_protocol:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_finance_combo:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_finance_combo:python_functions
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:protected_finance_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 783.3ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:protected_finance_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.institution.admin_finance_status`
  errors: missing_expected_keyword
  answer: Resumo financeiro das contas vinculadas:
- Total de faturas em aberto: 3
- Total de faturas vencidas: 0
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_finance_combo:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_finance_combo:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_finance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_finance_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_finance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_finance_panorama:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_open_world_out_of_scope:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_open_world_out_of_scope:python_functions
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_scope_boundary_surface
context_repair_reason: none
- `llamaindex`: status 200, latency 361.2ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `scope_boundary_fast_path`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_scope_boundary_fast_path`
  answer: Nao tenho base confiavel aqui no EduAssist do Colegio Horizonte para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_open_world_out_of_scope:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_open_world_out_of_scope:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_teacher_directory:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_teacher_directory:python_functions
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_teacher_directory:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 13498.9ms, keyword pass `False`, quality `68`, used_llm `True`, llm_stages `grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `early_return`, answer_experience_applied `True`, answer_experience_reason `structured_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `fato institucional canonico deve vir de fonte estruturada`
  errors: missing_expected_keyword, unnecessary_clarification
  answer: Sinto muito, mas meu conhecimento está restrito às informações do Colégio Horizonte. Não tenho como saber o horário de fechamento da biblioteca pública municipal. Posso ajudar com informações sobre o calendário escolar, matrículas, regras ou qualquer outro assunto relacionado à escola?
[debug]
stack: langgraph
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_external_library_boundary:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_external_library_boundary:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > turn_frame:input_clarification > python_functions:native_runtime > kernel:python_functions
...
answer_experience_reason: structured_grounded_answer
context_repair_reason: none
- `llamaindex`: status 200, latency 7498.4ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `True`, answer_experience_reason `structured_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `contextual_public_boundary_fast_path`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_contextual_public_boundary_fast_path`
  errors: missing_expected_keyword
  answer: Sinto muito, mas meu conhecimento é focado exclusivamente no Colégio Horizonte. Não tenho informações sobre o horário de funcionamento da biblioteca pública municipal. Posso ajudar com qualquer dúvida sobre a escola, como matrícula, calendário, regras ou informações gerais do Colégio Horizonte.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_external_library_boundary:llamaindex
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 37563.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_fast_path:scope_boundary`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_fast_path:scope_boundary`
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_external_library_boundary:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fast_path > scope_boundary
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_service_routing:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_service_routing:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_service_routing:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_service_routing:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_teacher_schedule_panorama:langgraph
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 6796.9ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.teacher.schedule`
  answer: Resumo docente de Fernando Azevedo: 10 turma(s) e 6 disciplina(s) ativas nesta base. Disciplinas: Fisica, Quimica, Filosofia, Historia. Turmas: 1o Ano A, 1o Ano B, 2o Ano A, 2o Ano B. No uso do calendario publico da escola, priorize datas institucionais abertas a familias e equipe, como reunioes, simulados, conselhos e janelas letivas publicadas. Nos canais oficiais da escola, a secretaria continua sendo o contato institucional mais seguro para comunicacao geral; para alinhamentos pedagogicos, o fluxo correto passa por coordenacao e orientacao conforme o assunto.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_teacher_schedule_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_teacher_schedule_panorama:specialist_supervisor
ingress: none:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `python_functions`: status 200, latency 7028.6ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_teacher_schedule`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_teacher_schedule`
  answer: Grade docente de Fernando Azevedo no Ensino Medio:
- 1o Ano A - Fisica (2026)
- 1o Ano A - Quimica (2026)
- 1o Ano B - Filosofia (2026)
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 3696.5ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier, grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.teacher.schedule`
  answer: A grade docente de Fernando Azevedo no Ensino Médio é a seguinte: - 1º Ano A - Física (2026) - 1º Ano A - Química (2026) - 1º Ano B - Filosofia (2026) - 1º Ano B - História (2026) - 2º Ano A - Filosofia (2026) - 2º Ano A - Física (2026) - 2º Ano A - Química (2026) - 2º Ano B - Filosofia (2026)
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
...
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 279.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_fast_path:teacher_schedule`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_fast_path:teacher_schedule`
  answer: Grade docente de Fernando Azevedo no Ensino Medio:
- 1o Ano A - Fisica (2026)
- 1o Ano A - Quimica (2026)
- 1o Ano B - Filosofia (2026)
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_known_unknown_total_teachers:langgraph
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_known_unknown_total_teachers:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_no_match:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_no_match:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 729.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_no_match`
  answer: Nao encontrei uma orientacao restrita especifica sobre excursao ou viagem internacional com hospedagem para o ensino medio nos documentos internos disponiveis. Na pratica, o proximo passo e consultar o setor responsavel por esse protocolo interno ou eu posso trazer apenas o correspondente publico.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_no_match:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_no_match:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_pricing_projection:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_pricing_projection:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_pricing_projection:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_pricing_projection:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 2121.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_upcoming_assessments:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_upcoming_assessments:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_upcoming_assessments:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_upcoming_assessments:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_docs:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_docs:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `llamaindex`: status 200, latency 1039.0ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `o turno atual trouxe pistas explicitas de outro dominio protegido e o roteamento foi corrigido`
  answer: Panorama documental das contas vinculadas:
- Lucas Oliveira: situacao documental regular.
- Ana Oliveira: situacao documental com pendencias. Ponto pendente: Ainda falta anexar um comprovante de residencia atualizado para Ana Oliveira concluir a conferencia documental. Proximo passo: Envie o comprovante atualizado pelo portal autenticado ou pela secretaria escolar para concluir a analise.
Quem ainda tem pendencia documental mais clara neste recorte: Ana Oliveira.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_docs:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_admin_docs:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_facilities_study:langgraph
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_facilities_study:llamaindex
ingress: unknown:none
...
- `langgraph`: status 200, latency 840.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_no_match`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_teacher_manual:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_teacher_manual:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_teacher_manual:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 1015.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_no_match`
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_teacher_manual:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_family_panorama:langgraph
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_family_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_protected_family_panorama` turn `1`
- `langgraph`: status 200, latency 13678.7ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `answer_composition, context_repair_planner`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `mode_not_polishable`, answer_experience_applied `True`, answer_experience_reason `clarify_repair_grounded_answer:context_repair_clarify_after_retry`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `a intencao esta ambigua e exige clarificacao antes de recuperar contexto`
  errors: missing_expected_keyword
...
- `python_functions`: status 599, latency 1005.8ms, keyword pass `False`, quality `0`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `exception`
  errors: request_failed
  error_detail: HTTPStatusError: Server error '500 Internal Server Error' for url 'http://127.0.0.1:8007/v1/messages/respond'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
  answer: 
- `llamaindex`: status 599, latency 900.6ms, keyword pass `False`, quality `0`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `exception`
  errors: request_failed
  error_detail: HTTPStatusError: Server error '500 Internal Server Error' for url 'http://127.0.0.1:8008/v1/messages/respond'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
  answer: 
- `specialist_supervisor`: status 200, latency 230.6ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_access_scope:langgraph
ingress: unknown:none
...
- `python_functions`: status 599, latency 625.7ms, keyword pass `False`, quality `0`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `exception`
  errors: request_failed
  error_detail: HTTPStatusError: Server error '500 Internal Server Error' for url 'http://127.0.0.1:8007/v1/messages/respond'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
  answer: 
- `llamaindex`: status 599, latency 674.9ms, keyword pass `False`, quality `0`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `exception`
  errors: request_failed
  error_detail: HTTPStatusError: Server error '500 Internal Server Error' for url 'http://127.0.0.1:8008/v1/messages/respond'
For more information check: https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/500
  answer: 
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_access_scope:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 1274.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_scope_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_scope_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_scope_protocol:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 722.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_search`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_search`
  answer: Para o pedido sobre limites de acesso no Telegram para responsaveis com escopo parcial, o protocolo interno mais relevante e este:
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_scope_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_family_new_bundle:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_family_new_bundle:llamaindex
ingress: unknown:none
...
- `langgraph`: status 200, latency 1474.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_attendance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `python_functions`: status 200, latency 983.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `python_functions_native_family_attendance_aggregate`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_family_attendance_aggregate`
  answer: Panorama de frequencia das contas vinculadas:
- Lucas Oliveira: 6 falta(s), 7 atraso(s), 19 presenca(s), 370 minuto(s) de ausencia. Ponto mais sensivel: Biologia (1 falta(s), 0 atraso(s)).
- Ana Oliveira: 6 falta(s), 9 atraso(s), 17 presenca(s), 410 minuto(s) de ausencia. Ponto mais sensivel: Portugues (1 falta(s), 1 atraso(s)).
Quem exige maior atencao agora: Ana Oliveira. O ponto mais sensivel aparece em Portugues.
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_attendance_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_attendance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_attendance_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_protected_attendance_panorama` turn `1`
- `langgraph`: status 200, latency 22251.5ms, keyword pass `False`, quality `31`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 22685.2ms, keyword pass `False`, quality `31`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.academic.attendance`
  errors: attendance_metric_misroute, forbidden_entity_or_value
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Fisica 5,9; Historia 6,8; Matematica 7,7; Portugues 8,3
- Ana Oliveira: Fisica 6,4; Historia 7,3; Matematica 7,4; Portugues 8,4
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_discipline_recovery:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_discipline_recovery:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_public_discipline_recovery:specialist_supervisor
ingress: none:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_boundary_auth_needed:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_protected_boundary_auth_needed:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 7407.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_finance_playbook:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `python_functions`: status 200, latency 7233.7ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_restricted_document_search`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_restricted_document_search`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
Nos documentos internos consultados, a orientacao mais relevante aparece em Procedimento interno para pagamento parcial e negociacao:
Secao relevante: Procedimento interno para pagamento parcial e negociacao.
Quando a familia informa pagamento parcial, o financeiro deve registrar o valor pago, saldo pendente e canal de contato antes de propor negociacao. O sistema nao deve assumir quitacao total sem evidencia transacional.
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_finance_playbook:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 7084.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
Nos documentos internos consultados, a orientacao mais relevante aparece em Procedimento interno para pagamento parcial e negociacao:
Secao relevante: Procedimento interno para pagamento parcial e negociacao.
Quando a familia informa pagamento parcial, o financeiro deve registrar o valor pago, saldo pendente e canal de contato antes de propor negociacao. O sistema nao deve assumir quitacao total sem evidencia transacional.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_finance_playbook:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T163141Z:retrieval_restricted_finance_playbook:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
