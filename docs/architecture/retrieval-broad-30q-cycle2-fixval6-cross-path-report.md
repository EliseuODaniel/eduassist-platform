...
Date: 2026-04-15T17:49:46.534966+00:00
...
| --- | --- | --- | --- | --- | --- |
| `langgraph` | `29/30` | `26/30` | `92.6` | `6133.2 ms` | `0/30` |
| `python_functions` | `30/30` | `26/30` | `94.0` | `5256.6 ms` | `0/30` |
| `llamaindex` | `30/30` | `26/30` | `94.0` | `5627.8 ms` | `5/30` |
| `specialist_supervisor` | `30/30` | `29/30` | `97.8` | `1144.5 ms` | `0/30` |

## By Slice

- `protected`
  - `langgraph`: ok 12/13, keyword pass 9/13, quality 83.0, latency 6470.7ms, final polish 0/13
  - `python_functions`: ok 13/13, keyword pass 9/13, quality 86.2, latency 4116.0ms, final polish 0/13
  - `llamaindex`: ok 13/13, keyword pass 9/13, quality 86.2, latency 3763.0ms, final polish 0/13
  - `specialist_supervisor`: ok 13/13, keyword pass 12/13, quality 95.0, latency 288.3ms, final polish 0/13
- `public`
  - `langgraph`: ok 11/11, keyword pass 11/11, quality 100.0, latency 8412.6ms, final polish 0/11
  - `python_functions`: ok 11/11, keyword pass 11/11, quality 100.0, latency 8887.2ms, final polish 0/11
  - `llamaindex`: ok 11/11, keyword pass 11/11, quality 100.0, latency 10321.0ms, final polish 5/11
  - `specialist_supervisor`: ok 11/11, keyword pass 11/11, quality 100.0, latency 2352.9ms, final polish 0/11
- `restricted`
  - `langgraph`: ok 6/6, keyword pass 6/6, quality 100.0, latency 1223.0ms, final polish 0/6
  - `python_functions`: ok 6/6, keyword pass 6/6, quality 100.0, latency 1071.9ms, final polish 0/6
  - `llamaindex`: ok 6/6, keyword pass 6/6, quality 100.0, latency 1063.9ms, final polish 0/6
  - `specialist_supervisor`: ok 6/6, keyword pass 6/6, quality 100.0, latency 784.4ms, final polish 0/6

## Error Types

- `langgraph`: attendance_metric_misroute=1, forbidden_entity_or_value=1, missing_expected_keyword=2, request_failed=1, unnecessary_clarification=1
- `python_functions`: attendance_metric_misroute=1, forbidden_entity_or_value=2, missing_expected_keyword=2, multi_intent_partial_collapse=1
- `llamaindex`: attendance_metric_misroute=1, forbidden_entity_or_value=2, missing_expected_keyword=2, multi_intent_partial_collapse=1
- `specialist_supervisor`: forbidden_entity_or_value=1, missing_expected_keyword=1
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_docs_credentials:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_docs_credentials:python_functions
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_docs_credentials:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_staff_finance_protocol:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_staff_finance_protocol:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_staff_finance_protocol:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_staff_finance_protocol:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_denied:langgraph
ingress: unknown:none
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 242.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_access_deny`
  answer: Nao posso compartilhar procedimentos, protocolos, manuais ou playbooks internos da escola por este canal, porque este perfil nao tem acesso a esse material restrito. Se quiser, eu posso orientar pelo material publico correspondente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_denied:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_denied:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_governance_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_governance_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_governance_protocol:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_finance_combo:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_finance_combo:python_functions
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 604.0ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.institution.admin_finance_status`
  errors: missing_expected_keyword
  answer: Resumo financeiro das contas vinculadas:
- Total de faturas em aberto: 3
- Total de faturas vencidas: 0
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_finance_combo:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_finance_combo:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_finance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_finance_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_finance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_finance_panorama:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_open_world_out_of_scope:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_open_world_out_of_scope:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_open_world_out_of_scope:llamaindex
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_teacher_directory:langgraph
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_teacher_directory:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_external_library_boundary:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: structured_grounded_answer:public_direct_answer
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 17082.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_fast_path:scope_boundary`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_fast_path:scope_boundary`
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_external_library_boundary:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fast_path > scope_boundary
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_service_routing:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_service_routing:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_service_routing:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_service_routing:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_teacher_schedule_panorama:langgraph
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 6953.4ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.teacher.schedule`
  answer: Resumo docente de Fernando Azevedo: 10 turma(s) e 6 disciplina(s) ativas nesta base. Disciplinas: Fisica, Quimica, Filosofia, Historia. Turmas: 1o Ano A, 1o Ano B, 2o Ano A, 2o Ano B. No uso do calendario publico da escola, priorize datas institucionais abertas a familias e equipe, como reunioes, simulados, conselhos e janelas letivas publicadas. Nos canais oficiais da escola, a secretaria continua sendo o contato institucional mais seguro para comunicacao geral; para alinhamentos pedagogicos, o fluxo correto passa por coordenacao e orientacao conforme o assunto.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_teacher_schedule_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_teacher_schedule_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_teacher_schedule_panorama` turn `1`
- `langgraph`: status 200, latency 7782.0ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `teacher_role_rescue`
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `python_functions`: status 200, latency 7069.1ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_teacher_schedule`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_teacher_schedule`
  answer: Grade docente de Fernando Azevedo no Ensino Medio:
- 1o Ano A - Fisica (2026)
- 1o Ano A - Quimica (2026)
- 1o Ano B - Filosofia (2026)
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_known_unknown_total_teachers:langgraph
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_known_unknown_total_teachers:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_no_match:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 910.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_no_match`
  answer: Nao encontrei uma orientacao restrita especifica sobre excursao ou viagem internacional com hospedagem para o ensino medio nos documentos internos disponiveis. Na pratica, o proximo passo e consultar o setor responsavel por esse protocolo interno ou eu posso trazer apenas o correspondente publico.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_no_match:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_no_match:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_pricing_projection:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_pricing_projection:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_pricing_projection:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_pricing_projection:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_upcoming_assessments:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_upcoming_assessments:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_upcoming_assessments:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_upcoming_assessments:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_docs:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_docs:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `llamaindex`: status 200, latency 940.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `o turno atual trouxe pistas explicitas de outro dominio protegido e o roteamento foi corrigido`
  answer: Panorama documental das contas vinculadas:
- Lucas Oliveira: situacao documental regular.
- Ana Oliveira: situacao documental com pendencias. Ponto pendente: Ainda falta anexar um comprovante de residencia atualizado para Ana Oliveira concluir a conferencia documental. Proximo passo: Envie o comprovante atualizado pelo portal autenticado ou pela secretaria escolar para concluir a analise.
Quem ainda tem pendencia documental mais clara neste recorte: Ana Oliveira.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_docs:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_admin_docs:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_facilities_study:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_facilities_study:python_functions
ingress: unknown:none
...
- `langgraph`: status 200, latency 814.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_no_match`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_teacher_manual:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `python_functions`: status 200, latency 759.9ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_restricted_document_no_match`
  answer: Consultei os documentos internos disponiveis, mas nao encontrei uma orientacao restrita especifica para: "Sem sair do escopo do projeto, no manual interno do professor, como ficam registro de avaliacoes e comunicacao pedagogica". Na pratica, esta base nao trouxe detalhe interno suficiente para responder com seguranca; o proximo passo e consultar o setor responsavel ou pedir apenas o material publico correspondente.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_teacher_manual:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 701.2ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_no_match`
  answer: Consultei os documentos internos disponiveis, mas nao encontrei uma orientacao restrita especifica para: "Sem sair do escopo do projeto, no manual interno do professor, como ficam registro de avaliacoes e comunicacao pedagogica". Na pratica, esta base nao trouxe detalhe interno suficiente para responder com seguranca; o proximo passo e consultar o setor responsavel ou pedir apenas o material publico correspondente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_teacher_manual:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_teacher_manual:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_family_panorama:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_family_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_family_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_family_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_protected_family_panorama` turn `1`
- `langgraph`: status 200, latency 14166.2ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `answer_composition, grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `mode_not_polishable`, answer_experience_applied `True`, answer_experience_reason `clarify_repair_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `a intencao esta ambigua e exige clarificacao antes de recuperar contexto`
  errors: missing_expected_keyword
  answer: Não tenho informações documentais disponíveis para identificar o ponto acadêmico mais fraco da Ana.
[debug]
stack: langgraph
bundle: langgraph
corr: none
...
context_repair_reason: none
- `python_functions`: status 200, latency 1070.3ms, keyword pass `False`, quality `55`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_structured:academic`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_structured:academic`
...
answer_experience_reason: protected_grounded_answer:protected_academic_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 1041.7ms, keyword pass `False`, quality `55`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.academic.family_comparison`
  errors: forbidden_entity_or_value
  answer: Comparando Lucas Oliveira com Ana Oliveira: Lucas Oliveira tem o ponto academico mais sensivel em Fisica, com media parcial 5,9/10, enquanto Ana Oliveira aparece com menor media em Fisica, com 6,4/10. Hoje quem esta mais perto da media minima entre os dois e Lucas Oliveira, puxado por Fisica.
[debug]
stack: llamaindex
...
- `langgraph`: status 200, latency 815.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_protected_finance_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_access_scope:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_access_scope:python_functions
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:protected_academic_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 742.6ms, keyword pass `False`, quality `54`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_protected_records_fast_path`
  errors: missing_expected_keyword, multi_intent_partial_collapse
  answer: Comparando Lucas Oliveira com Ana Oliveira: Lucas Oliveira tem o ponto academico mais sensivel em Fisica, com media parcial 5,9/10, enquanto Ana Oliveira aparece com menor media em Fisica, com 6,4/10. Hoje quem esta mais perto da media minima entre os dois e Lucas Oliveira, puxado por Fisica.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_access_scope:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_access_scope:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 1168.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_scope_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_scope_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 1107.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
  answer: Para o pedido sobre limites de acesso no Telegram para responsaveis com escopo parcial, o protocolo interno mais relevante e este:
Nos documentos internos consultados, a orientacao mais relevante aparece em Protocolo interno para responsaveis com escopo parcial:
Secao relevante: Protocolo interno para responsaveis com escopo parcial.
Responsaveis com escopo parcial exigem validacao cuidadosa para evitar vazamento de dados. A equipe deve conferir se o vinculo vigente concede acesso academico, financeiro ou ambos.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_scope_protocol:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 1017.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_search`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_search`
  answer: Para o pedido sobre limites de acesso no Telegram para responsaveis com escopo parcial, o protocolo interno mais relevante e este:
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_scope_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
...
- `langgraph`: status 200, latency 25250.3ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:public_direct_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_turn_frame:public_answer`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_family_new_bundle:langgraph
ingress: unknown:none
...
- `langgraph`: status 200, latency 1614.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_attendance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_attendance_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_attendance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_attendance_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_protected_attendance_panorama` turn `1`
- `langgraph`: status 200, latency 22505.0ms, keyword pass `False`, quality `31`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 20951.1ms, keyword pass `False`, quality `31`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.academic.attendance`
  errors: attendance_metric_misroute, forbidden_entity_or_value
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Fisica 5,9; Historia 6,8; Matematica 7,7; Portugues 8,3
- Ana Oliveira: Fisica 6,4; Historia 7,3; Matematica 7,4; Portugues 8,4
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_discipline_recovery:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_public_discipline_recovery:specialist_supervisor
ingress: none:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_boundary_auth_needed:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > turn_frame:auth_guidance > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: light_polish (eligible)
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_boundary_auth_needed:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_protected_boundary_auth_needed:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 1263.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_restricted_document_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_finance_playbook:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_restricted_document_surface
context_repair_reason: none
- `python_functions`: status 200, latency 1227.8ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_restricted_document_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_restricted_document_search`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_restricted_document_search`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
Nos documentos internos consultados, a orientacao mais relevante aparece em Procedimento interno para pagamento parcial e negociacao:
Secao relevante: Procedimento interno para pagamento parcial e negociacao.
Quando a familia informa pagamento parcial, o financeiro deve registrar o valor pago, saldo pendente e canal de contato antes de propor negociacao. O sistema nao deve assumir quitacao total sem evidencia transacional.
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_finance_playbook:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_restricted_document_surface
context_repair_reason: none
- `llamaindex`: status 200, latency 1152.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_restricted_document_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
Nos documentos internos consultados, a orientacao mais relevante aparece em Procedimento interno para pagamento parcial e negociacao:
Secao relevante: Procedimento interno para pagamento parcial e negociacao.
Quando a familia informa pagamento parcial, o financeiro deve registrar o valor pago, saldo pendente e canal de contato antes de propor negociacao. O sistema nao deve assumir quitacao total sem evidencia transacional.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_finance_playbook:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_restricted_document_surface
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 581.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_search`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_search`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T174041Z:retrieval_restricted_finance_playbook:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
