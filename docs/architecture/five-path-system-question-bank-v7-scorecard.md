# Five-Path System Question Bank v7 Scorecard

## Overall

| Stack | OK | Quality | Avg latency | Error types |
| --- | --- | --- | --- | --- |
| `langgraph` | `96/96` | `99.9` | `931.0 ms` | `repetitive_reply=1` |
| `crewai` | `96/96` | `99.9` | `4860.1 ms` | `repetitive_reply=1` |
| `python_functions` | `96/96` | `100.0` | `149.7 ms` | `nenhum` |
| `llamaindex` | `96/96` | `100.0` | `1629.6 ms` | `nenhum` |
| `specialist_supervisor` | `96/96` | `100.0` | `3776.5 ms` | `nenhum` |

## Rankings

- qualidade: `python_functions`, `llamaindex`, `specialist_supervisor`, `langgraph`, `crewai`
...
| Stack | OK | Quality | Avg latency |
| --- | --- | --- | --- |
| `langgraph` | `16/16` | `99.4` | `703.3 ms` |
| `crewai` | `16/16` | `99.4` | `3065.4 ms` |
| `python_functions` | `16/16` | `100.0` | `160.2 ms` |
| `llamaindex` | `16/16` | `100.0` | `1679.7 ms` |
| `specialist_supervisor` | `16/16` | `100.0` | `4753.5 ms` |
