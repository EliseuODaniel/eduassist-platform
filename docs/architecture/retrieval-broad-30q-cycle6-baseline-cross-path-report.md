...
Date: 2026-04-16T06:28:14.756639+00:00

Dataset: `/home/edann/projects/eduassist-platform/tests/evals/datasets/retrieval_broad_30q_probe_cases.generated.20260416.cycle6.json`
...
| --- | --- | --- | --- | --- | --- |
| `langgraph` | `30/30` | `30/30` | `99.7` | `3011.3 ms` | `0/30` |
| `python_functions` | `30/30` | `28/30` | `97.5` | `4641.9 ms` | `0/30` |
| `llamaindex` | `30/30` | `28/30` | `97.5` | `4106.5 ms` | `5/30` |
| `specialist_supervisor` | `30/30` | `28/30` | `98.7` | `1558.0 ms` | `0/30` |

## By Slice

- `protected`
  - `langgraph`: ok 13/13, keyword pass 13/13, quality 99.2, latency 2231.1ms, final polish 0/13
  - `python_functions`: ok 13/13, keyword pass 12/13, quality 97.7, latency 2437.9ms, final polish 0/13
  - `llamaindex`: ok 13/13, keyword pass 12/13, quality 97.7, latency 1903.2ms, final polish 0/13
  - `specialist_supervisor`: ok 13/13, keyword pass 12/13, quality 98.5, latency 267.1ms, final polish 0/13
- `public`
  - `langgraph`: ok 11/11, keyword pass 11/11, quality 100.0, latency 4860.7ms, final polish 0/11
  - `python_functions`: ok 11/11, keyword pass 11/11, quality 100.0, latency 8171.3ms, final polish 0/11
  - `llamaindex`: ok 11/11, keyword pass 11/11, quality 100.0, latency 7400.7ms, final polish 5/11
  - `specialist_supervisor`: ok 11/11, keyword pass 11/11, quality 100.0, latency 1064.8ms, final polish 0/11
- `restricted`
  - `langgraph`: ok 6/6, keyword pass 6/6, quality 100.0, latency 1311.2ms, final polish 0/6
  - `python_functions`: ok 6/6, keyword pass 5/6, quality 92.3, latency 2946.8ms, final polish 0/6
  - `llamaindex`: ok 6/6, keyword pass 5/6, quality 92.3, latency 2841.2ms, final polish 0/6
  - `specialist_supervisor`: ok 6/6, keyword pass 5/6, quality 96.7, latency 5259.1ms, final polish 0/6

## Error Types

- `langgraph`: weak_actionability=1
- `python_functions`: missing_expected_keyword=2, multi_intent_partial_collapse=1, weak_actionability=1
- `llamaindex`: missing_expected_keyword=2, multi_intent_partial_collapse=1, weak_actionability=1
...
- `langgraph`: status 200, latency 8351.0ms, keyword pass `True`, quality `90`, used_llm `True`, llm_stages `grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
  errors: weak_actionability
  answer: Para que eu possa montar o quadro com as turmas e disciplinas que você leciona, preciso que você me informe o nome ou o código de um aluno que faz parte do seu quadro de turmas. Com essa informação, consigo consultar os dados acadêmicos e montar o panorama que você precisa.
[debug]
stack: langgraph
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_teacher_schedule_panorama:langgraph
...
answer_experience_reason: protected_grounded_answer
context_repair_reason: none
- `llamaindex`: status 200, latency 6417.6ms, keyword pass `True`, quality `90`, used_llm `True`, llm_stages `grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  errors: weak_actionability
  answer: Para que eu possa montar o quadro das turmas e disciplinas que você leciona, preciso que você me informe o nome ou o código do aluno que você deseja consultar.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_teacher_schedule_panorama:llamaindex
ingress: unknown:none
...
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_teacher_schedule_panorama:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_access_scope:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_access_scope:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_access_scope:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_access_scope:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_governance_protocol:langgraph
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_scope_protocol:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_scope_protocol:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_scope_protocol:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_scope_protocol:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_denied:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_denied:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:unknown > mode:clarify > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 245.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_access_deny`
  answer: Nao posso compartilhar procedimentos, protocolos, manuais ou playbooks internos da escola por este canal, porque este perfil nao tem acesso a esse material restrito. Se quiser, eu posso orientar pelo material publico correspondente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_denied:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_denied:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_facilities_study:langgraph
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_student_academic_self:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:protected_academic_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 773.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Hoje, a melhor disciplina de Miguel Pereira e Portugues, com media parcial 8,7/10. A pior disciplina aparece em Fisica, com 8,0/10. Em Fisica, a media parcial atual ja esta em 8,0/10 e a media minima de 7,0 ja foi alcancada; faltam 0,0 ponto(s) para fechar a media.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_student_academic_self:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_student_academic_self:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_family_new_bundle:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: structured_grounded_answer:preserve_public_canonical_lane
context_repair_reason: none
- `llamaindex`: status 200, latency 421.5ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `public_answer_composer`, final_polish_applied `True`, final_polish_mode `grounded_public_composition`, final_polish_reason `public_answer_composer`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_public_canonical_lane`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `public_canonical_lane:public_bundle.family_new_calendar_assessment_enrollment`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_public_canonical_lane:public_bundle.family_new_calendar_assessment_enrollment`
  answer: Para uma familia nova, os tres documentos cumprem papeis diferentes e complementares, e fazem mais sentido quando lidos em ordem. Primeiro entram matricula, documentacao inicial, envio digital e canais de atendimento. Depois entram calendario letivo e inicio das aulas, para organizar o comeco do ano. Na sequencia entram agenda de avaliacoes, devolutivas e recuperacoes, para a familia nao perder os marcos pedagogicos. Calendario letivo: As aulas do ensino fundamental II e do ensino medio comecam em 2 de fevereiro de 2026. Ingresso e marcos do ano: O ciclo publico de matricula para 2026 foi aberto em 6 de outubro de 2025, com pre-cadastro, visita guiada opcional e triagem documental inicial. Relacao com a familia: As reunioes gerais com responsaveis acontecem em 28 de março, 27 de junho, 19 de setembro e 12 de dezembro de 2026. Agenda de avaliacoes: As avaliacoes bimestrais seguem o planejamento pedagogico de cada segmento e sao publicadas com antecedencia no portal academico. Recuperacao e ajustes: A recuperacao paralela acontece ao longo do bimestre, com reforco, devolutiva e atividades de recomposicao de aprendizagem. Comunicacao com responsaveis: Sempre que houver ajuste relevante no calendario de avaliacao, a escola atualiza o portal e reforca a comunicacao pelos canais oficiais. Manual de matricula: O processo de matricula ocorre em quatro etapas: pre-cadastro, envio de documentos, validacao pela secretaria e assinatura contratual. Documentos e envio: Sao exigidos documento de identidade do aluno, CPF quando houver, historico escolar, comprovante de residencia atualizado, documento de identificacao do responsavel legal e formulario cadastral preenchido. O envio inicial dos documentos pode ser feito pelo portal institucional ou pelo e-mail oficial da secretaria para triagem e validacao. Em periodos de alta demanda, o atendimento inicial prioriza orientacao documental e agendamento. Na pratica, a familia usa o manual para entrar corretamente, o calendario para se orientar antes e logo depois do inicio das aulas, e a agenda para acompanhar provas, comunicados e recuperacoes.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_family_new_bundle:llamaindex
ingress: unknown:none
...
- `langgraph`: status 200, latency 20616.0ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:public_direct_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_turn_frame:public_answer`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_discipline_recovery:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call > turn_frame:public.curriculum.overview > langgraph_response_workflow > semantic_ingress
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: structured_grounded_answer:public_direct_answer
context_repair_reason: none
- `python_functions`: status 200, latency 16893.7ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `light_polish`, final_polish_reason `python_functions_semantic_ingress_terminal`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:public_direct_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_semantic_ingress:curriculum`
  answer: Na pratica, convivencia, frequencia, recuperacao e promocao precisam ser lidas como um mesmo fluxo academico. O processo avaliativo combina instrumentos formativos e somativos, como atividades em aula, projetos, producoes textuais, simulados e provas bimestrais. Resultados parciais sao apresentados ao estudante e a familia por meio do portal academico, reunioes e devolutivas pedagogicas. Quando houver desempenho abaixo do esperado, a escola pode oferecer recuperacao paralela, atividades orientadas, monitoria, estudo dirigido ou avaliacao substitutiva, conforme o componente e o periodo do ano. Pedidos de segunda chamada exigem justificativa no prazo orientado pela escola. Na referencia publica atual, a escola trabalha com media 7,0/10 e frequencia minima de 75,0% por componente. A promocao considera desempenho global, trajetoria do estudante, recuperacao realizada e frequencia. Primeiro a familia acompanha criterio, devolutiva e frequencia; depois usa segunda chamada e recuperacao quando houver impacto academico; e, por fim, observa a decisao final de promocao pelo canal oficial.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_discipline_recovery:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > turn_frame:public.curriculum.overview > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: light_polish (eligible)
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_discipline_recovery:llamaindex
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_finance_combo:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_finance_combo:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_finance_combo:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_finance_combo:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_external_library_boundary:langgraph
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_scope_boundary_surface
context_repair_reason: none
- `llamaindex`: status 200, latency 465.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `True`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `external_public_facility_boundary_fast_path`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_external_public_facility_boundary_fast_path`
  answer: Nao tenho base confiavel aqui para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_external_library_boundary:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:unknown > mode:clarify > llamaindex:public > llamaindex:external_public_facility_boundary_fast_path > kernel:llamaindex
llm: no
final_polish: skip
answer_experience: applied (openai/ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M)
context_repair: off
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_external_library_boundary:specialist_supervisor
ingress: none:none
...
### De forma bem objetiva, para falar com o professor de matematica, o contato e publico ou a familia precisa passar pela coordenacao?
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_teacher_directory:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_teacher_directory:python_functions
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_docs_credentials:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_docs_credentials:specialist_supervisor
ingress: none:none
...
### Pensando no caso pratico, mostre em resumo as proximas avaliacoes dos meus filhos para eu me organizar.
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_upcoming_assessments:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_upcoming_assessments:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_upcoming_assessments:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_upcoming_assessments:specialist_supervisor
ingress: none:none
...
### Pensando no caso pratico, quero um retrato das pendencias documentais da Ana e do proximo passo para regularizar tudo.

- Slice: `protected`
- Thread: `retrieval_protected_admin_docs` turn `1`
- `langgraph`: status 200, latency 3969.0ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `status administrativo autenticado exige service deterministico`
  answer: Ana Oliveira ainda possui pendências na documentação. Para regularizar a situação, o próximo passo é enviar o comprovante atualizado, que pode ser feito pelo portal autenticado ou diretamente na secretaria escolar, para que possamos concluir a análise.
[debug]
stack: langgraph
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_docs:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: yes (grounded_answer_experience)
final_polish: skip
...
answer_experience_reason: protected_grounded_answer
context_repair_reason: none
- `python_functions`: status 200, latency 2048.1ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier, grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_structured:institution`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_structured:institution`
  answer: Ana Oliveira ainda possui pendências na documentação. Para regularizar, o próximo passo é enviar o comprovante atualizado, que pode ser feito pelo portal autenticado ou diretamente na secretaria escolar, para que possamos concluir a análise.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_docs:python_functions
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer
context_repair_reason: none
- `llamaindex`: status 200, latency 1654.3ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier, grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.administrative.status`
  answer: Ana Oliveira ainda possui pendências na documentação. Para regularizar, o próximo passo é enviar o comprovante atualizado, seja pelo portal autenticado ou diretamente na secretaria escolar, para que possamos concluir a análise.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_docs:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_admin_docs:specialist_supervisor
ingress: none:none
...
answer_experience_reason: structured_grounded_answer
context_repair_reason: none
- `python_functions`: status 200, latency 7099.6ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `light_polish`, final_polish_reason `python_functions_semantic_ingress_terminal`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `visibility_boundary`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_semantic_ingress:auth_guidance`
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_boundary_auth_needed:python_functions
ingress: unknown:none
...
- `llamaindex`: status 200, latency 2142.3ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `semantic_ingress_classifier, grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `semantic_ingress_terminal`, answer_experience_applied `True`, answer_experience_reason `structured_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `semantic_ingress:auth_guidance`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_semantic_ingress:auth_guidance`
  answer: Para consultar suas notas, que são dados protegidos, você precisa primeiro vincular sua conta do Telegram ao portal da escola. Por favor, acesse o portal autenticado, gere o código de vinculação e, em seguida, envie aqui o comando /start link_<código>. Assim que você fizer isso, eu poderei consultar seus dados autorizados por este canal.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_boundary_auth_needed:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_boundary_auth_needed:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_service_routing:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_service_routing:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_service_routing:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_service_routing:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_staff_finance_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 12938.1ms, keyword pass `False`, quality `54`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_turn_frame:protected.documents.restricted_lookup`
  errors: missing_expected_keyword, multi_intent_partial_collapse
  answer: Nao encontrei um aluno vinculado a esta conta para essa consulta.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_staff_finance_protocol:llamaindex
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 28074.2ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `specialist_execution`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_direct:workflow_specialist`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_direct:workflow_specialist`
  errors: missing_expected_keyword
  answer: Como se trata de uma dúvida operacional específica sobre um fluxo interno de pagamento parcial, que requer validação de procedimentos e regras de negócio, é necessário encaminhar esta solicitação a um especialista humano da área de workflow. Por favor, aguarde que um analista de suporte especializado tome ciência do seu caso. Já abri um chamado de suporte para direcionar sua questão.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_staff_finance_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > retrieval_planner > specialist_direct > workflow_specialist
llm: yes (specialist_execution)
final_polish: skip
retrieval: backend=none, strategy=structured_tool, sources=1, supports=3, citations=0
reason: specialist_supervisor_direct:workflow_specialist
profile: gemma4e4b_local
provider: openai
agents: specialist_supervisor, retrieval_planner, specialist_direct, workflow_specialist
resources: tool:create_support_handoff, support:specialist:workflow_specialist, support:support_point:workflow_specialist

### Me de um quadro financeiro da familia hoje, com o que venceu, o que esta por vencer e o proximo passo recomendado. Traga a resposta de forma concreta.

- Slice: `protected`
- Thread: `retrieval_protected_finance_panorama` turn `1`
- `langgraph`: status 200, latency 1206.2ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_protected_finance_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `o turno atual trouxe pistas explicitas de outro dominio protegido e o roteamento foi corrigido`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_finance_panorama:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_finance_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_finance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_finance_panorama:specialist_supervisor
ingress: none:none
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 795.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_no_match`
  answer: Consultei os documentos internos disponiveis, mas nao encontrei uma orientacao restrita especifica para: "Pelo manual interno do professor, qual e a regra para registro de avaliacoes e comunicacao com foco pedagogico. Traga a resposta de forma concreta". Na pratica, esta base nao trouxe detalhe interno suficiente para responder com seguranca; o proximo passo e consultar o setor responsavel ou pedir apenas o material publico correspondente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_teacher_manual:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_teacher_manual:specialist_supervisor
ingress: none:none
...
### Sem sair do escopo do projeto, quais parametros o playbook interno de negociacao financeira usa para decidir como conduzir a negociacao com a familia?
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_finance_playbook:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_finance_playbook:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_restricted_document_surface
context_repair_reason: none
- `llamaindex`: status 200, latency 1593.0ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_restricted_document_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
Nos documentos internos consultados, a orientacao mais relevante aparece em Procedimento interno para pagamento parcial e negociacao:
Secao relevante: Procedimento interno para pagamento parcial e negociacao.
Quando a familia informa pagamento parcial, o financeiro deve registrar o valor pago, saldo pendente e canal de contato antes de propor negociacao. O sistema nao deve assumir quitacao total sem evidencia transacional.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_finance_playbook:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_restricted_document_surface
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 748.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_search`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_search`
  answer: Para o pedido sobre o playbook interno de negociacao financeira com a familia, a orientacao mais relevante e esta:
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_finance_playbook:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
...
### De forma bem objetiva, sem me dar tabela, qual dos meus filhos esta academicamente pior hoje e em qual disciplina isso fica mais claro?

- Slice: `protected`
- Thread: `retrieval_protected_family_panorama` turn `1`
- `langgraph`: status 200, latency 1428.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_family_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `python_functions`: status 200, latency 997.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `python_functions_native_structured:academic`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_structured:academic`
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Fisica 5,9; Historia 6,8; Matematica 7,7; Portugues 8,3
- Ana Oliveira: Fisica 6,4; Historia 7,3; Matematica 7,4; Portugues 8,4
Quem hoje exige maior atencao academica e Lucas Oliveira, principalmente em Fisica.
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_family_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `llamaindex`: status 200, latency 868.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Fisica 5,9; Historia 6,8; Matematica 7,7; Portugues 8,3
- Ana Oliveira: Fisica 6,4; Historia 7,3; Matematica 7,4; Portugues 8,4
Quem hoje exige maior atencao academica e Lucas Oliveira, principalmente em Fisica.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_family_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_family_panorama:specialist_supervisor
ingress: none:none
...
### Sem sair do escopo do projeto, sem repetir o Lucas, corta so para a Ana e me diga qual componente dela acende mais alerta agora.

- Slice: `protected`
- Thread: `retrieval_protected_family_panorama` turn `1`
- `langgraph`: status 200, latency 1376.0ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `o turno atual trouxe pistas explicitas de outro dominio protegido e o roteamento foi corrigido`
...
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_family_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:unknown > mode:clarify > protected_domain_rescue > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
answer_experience: applied (openai/ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M)
context_repair: off
...
### Existe orientacao interna para viagem internacional com hospedagem envolvendo turmas do ensino medio. Traga a resposta de forma concreta.

- Slice: `restricted`
- Thread: `retrieval_restricted_no_match` turn `1`
- `langgraph`: status 200, latency 1121.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_no_match`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_no_match:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `python_functions`: status 200, latency 1610.7ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_restricted_document_no_match`
  answer: Nao encontrei uma orientacao restrita especifica sobre excursao ou viagem internacional com hospedagem para o ensino medio nos documentos internos disponiveis. Na pratica, o proximo passo e consultar o setor responsavel por esse protocolo interno ou eu posso trazer apenas o correspondente publico.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_no_match:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_no_match:llamaindex
ingress: unknown:none
...
answer_experience_reason: none
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 803.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_no_match`
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_restricted_no_match:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_pricing_projection:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_pricing_projection:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_pricing_projection:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_pricing_projection:specialist_supervisor
ingress: none:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_open_world_out_of_scope:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fast_path > scope_boundary
llm: no
final_polish: skip
...
### De forma bem objetiva, entre Ana e Lucas, quem esta mais delicado por frequencia hoje e por que esse alerta pesa mais?

- Slice: `protected`
- Thread: `retrieval_protected_attendance_panorama` turn `1`
- `langgraph`: status 200, latency 1455.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_attendance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `python_functions`: status 200, latency 1152.8ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_family_attendance_aggregate`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_family_attendance_aggregate`
  answer: Panorama de frequencia das contas vinculadas:
- Lucas Oliveira: 6 falta(s), 7 atraso(s), 19 presenca(s), 370 minuto(s) de ausencia. Ponto mais sensivel: Biologia (1 falta(s), 0 atraso(s)).
- Ana Oliveira: 6 falta(s), 9 atraso(s), 17 presenca(s), 410 minuto(s) de ausencia. Ponto mais sensivel: Portugues (1 falta(s), 1 atraso(s)).
Quem exige maior atencao agora: Ana Oliveira. O ponto mais sensivel aparece em Portugues.
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_attendance_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_attendance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_protected_attendance_panorama:specialist_supervisor
ingress: none:none
...
### De forma bem objetiva, continuando a analise, isole o Lucas e mostre por que a frequencia dele preocupa mais ou menos.

- Slice: `protected`
- Thread: `retrieval_protected_attendance_panorama` turn `1`
- `langgraph`: status 200, latency 1012.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:protected_attendance_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
### Quantos professores a escola tem hoje? Se isso nao estiver publicado, deixe claro. Traga a resposta de forma concreta.
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_known_unknown_total_teachers:langgraph
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:public_direct_answer
context_repair_reason: none
- `python_functions`: status 200, latency 13088.3ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:public_direct_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `deterministic_public_known_unknown`
  answer: Hoje os canais publicos de Colegio Horizonte nao informam a quantidade total de professores. Entao a pergunta e valida, mas esse dado nao esta publicado oficialmente.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_known_unknown_total_teachers:python_functions
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:public_direct_answer
context_repair_reason: none
- `llamaindex`: status 200, latency 14844.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:public_direct_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `known_unknown_fast_path`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_known_unknown_fast_path`
  answer: Hoje os canais publicos de Colegio Horizonte nao informam a quantidade total de professores. Entao a pergunta e valida, mas esse dado nao esta publicado oficialmente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_known_unknown_total_teachers:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260416T062135Z:retrieval_public_known_unknown_total_teachers:specialist_supervisor
ingress: none:none
