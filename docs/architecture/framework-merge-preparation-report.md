...
.env.example                                       |     7 +
 ...
 .../src/ai_orchestrator_crewai/listeners.py        |   522 +
 .../src/ai_orchestrator_crewai/main.py             |   173 +
 .../src/ai_orchestrator_crewai/protected_flow.py   |   517 +
 .../src/ai_orchestrator_crewai/protected_pilot.py  |   749 ++
 .../src/ai_orchestrator_crewai/public_flow.py      |   378 +
 .../src/ai_orchestrator_crewai/public_pilot.py     |   706 ++
 .../src/ai_orchestrator_crewai/support_flow.py     |   279 +
 .../src/ai_orchestrator_crewai/support_pilot.py    |   197 +
 .../src/ai_orchestrator_crewai/workflow_flow.py    |   389 +
 ...
 .../src/ai_orchestrator/crewai_trace.py            |   111 +
 .../src/ai_orchestrator/engine_selector.py         |   584 +
 .../src/ai_orchestrator/engines/__init__.py        |     6 +
 .../src/ai_orchestrator/engines/base.py            |    28 +
 .../src/ai_orchestrator/engines/crewai_engine.py   |   484 +
 ...
 apps/ai-orchestrator/src/ai_orchestrator/main.py   |   412 +-
 apps/ai-orchestrator/src/ai_orchestrator/models.py |    14 +
 .../src/ai_orchestrator/public_agentic_engine.py   |   364 +
 .../ai-orchestrator/src/ai_orchestrator/runtime.py | 12095 +++++++++++++++++--
 ...
 .../framework-rollout-readiness-report.md          |   140 +
 .../framework-slice-promotion-report.json          |    20 +
 ...
 tools/evals/apply_framework_rollout_promotion.py   |   430 +
 ...
 tools/evals/execute_framework_rollout_promotion.py |   408 +
 ...
 .../evals/preflight_framework_rollout_promotion.py |   335 +
 tools/evals/promote_framework_slice.py             |   273 +
