...
Date: 2026-04-15T07:54:21.130354+00:00
...
| --- | --- | --- | --- | --- | --- |
| `langgraph` | `30/30` | `25/30` | `95.9` | `6336.4 ms` | `1/30` |
| `python_functions` | `30/30` | `23/30` | `94.2` | `5748.7 ms` | `0/30` |
| `llamaindex` | `30/30` | `24/30` | `94.5` | `5892.6 ms` | `7/30` |
| `specialist_supervisor` | `30/30` | `25/30` | `95.9` | `1597.4 ms` | `1/30` |

## By Slice

- `protected`
  - `langgraph`: ok 13/13, keyword pass 11/13, quality 95.1, latency 5341.3ms, final polish 0/13
  - `python_functions`: ok 13/13, keyword pass 10/13, quality 93.5, latency 4540.5ms, final polish 0/13
  - `llamaindex`: ok 13/13, keyword pass 11/13, quality 95.1, latency 3764.3ms, final polish 0/13
  - `specialist_supervisor`: ok 13/13, keyword pass 11/13, quality 95.1, latency 1175.7ms, final polish 0/13
- `public`
  - `langgraph`: ok 11/11, keyword pass 8/11, quality 94.5, latency 8859.1ms, final polish 1/11
  - `python_functions`: ok 11/11, keyword pass 8/11, quality 93.6, latency 8925.5ms, final polish 0/11
  - `llamaindex`: ok 11/11, keyword pass 7/11, quality 90.9, latency 9468.3ms, final polish 7/11
  - `specialist_supervisor`: ok 11/11, keyword pass 9/11, quality 96.4, latency 2608.5ms, final polish 1/11
- `restricted`
  - `langgraph`: ok 6/6, keyword pass 6/6, quality 100.0, latency 3867.5ms, final polish 0/6
  - `python_functions`: ok 6/6, keyword pass 5/6, quality 96.7, latency 2542.1ms, final polish 0/6
  - `llamaindex`: ok 6/6, keyword pass 6/6, quality 100.0, latency 3948.3ms, final polish 0/6
  - `specialist_supervisor`: ok 6/6, keyword pass 5/6, quality 96.7, latency 657.3ms, final polish 0/6

## Error Types

- `langgraph`: attendance_metric_misroute=1, missing_expected_keyword=5
- `python_functions`: attendance_metric_misroute=1, missing_expected_keyword=7, weak_actionability=1
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_no_match:langgraph
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 5157.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_no_match`
  answer: Nao encontrei uma orientacao restrita especifica sobre excursao ou viagem internacional com hospedagem para o ensino medio nos documentos internos disponiveis. Na pratica, o proximo passo e consultar o setor responsavel por esse protocolo interno ou eu posso trazer apenas o correspondente publico.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_no_match:llamaindex
ingress: unknown:none
...
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_no_match:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_external_library_boundary:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_external_library_boundary:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_external_library_boundary:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_external_library_boundary:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_known_unknown_total_teachers:langgraph
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_facilities_study:langgraph
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_facilities_study:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_docs:langgraph
ingress: unknown:none
...
context_repair_reason: none
- `python_functions`: status 200, latency 761.7ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `python_functions_prefers_deterministic`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_turn_frame:scope_boundary`
  errors: missing_expected_keyword
  answer: Nao tenho base confiavel aqui no EduAssist do Colegio Horizonte para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_docs:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_docs:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_docs:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_finance_playbook:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_finance_playbook:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_finance_playbook:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_finance_playbook:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_teacher_directory:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_teacher_directory:python_functions
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_teacher_directory:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_open_world_out_of_scope:langgraph
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_scope_boundary_surface
context_repair_reason: none
- `python_functions`: status 200, latency 613.6ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `python_functions_prefers_deterministic`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_turn_frame:scope_boundary`
  answer: Nao tenho base confiavel aqui no EduAssist do Colegio Horizonte para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_open_world_out_of_scope:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:unknown > mode:clarify > turn_frame:scope_boundary > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_open_world_out_of_scope:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_open_world_out_of_scope:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_boundary_auth_needed:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_boundary_auth_needed:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_boundary_auth_needed:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_boundary_auth_needed:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 955.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_no_match`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_teacher_manual:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `python_functions`: status 200, latency 857.0ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `documentary_synthesis`, candidate_reason `python_functions_native_restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_restricted_document_no_match`
  answer: Consultei os documentos internos disponiveis, mas nao encontrei uma orientacao restrita especifica para: "Sem sair do escopo do projeto, pelo manual interno do professor, qual e a regra para registro de avaliacoes e comunicacao com foco pedagogico". Na pratica, esta base nao trouxe detalhe interno suficiente para responder com seguranca; o proximo passo e consultar o setor responsavel ou pedir apenas o material publico correspondente.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_teacher_manual:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_teacher_manual:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_teacher_manual:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_discipline_recovery:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_discipline_recovery:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_discipline_recovery:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 8109.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_staff_finance_protocol:langgraph
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `python_functions`: status 200, latency 602.7ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `python_functions_prefers_deterministic`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_turn_frame:scope_boundary`
  errors: missing_expected_keyword
  answer: Nao tenho base confiavel aqui no EduAssist do Colegio Horizonte para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_staff_finance_protocol:python_functions
ingress: unknown:none
...
retrieval_retry: no
agents: python_functions:planner, kernel:python_functions
resources: tool:retrieve_restricted_documents, tool:search_documents, tool:get_public_school_profile, tool:python_functions_native_runtime, support:policy:scope_boundary
retrieval: backend=none, strategy=scope_boundary, sources=1, supports=1, citations=0
reason: python_functions_turn_frame:scope_boundary
final_polish_reason: python_functions_prefers_deterministic
answer_experience_reason: structured_grounded_answer:preserve_scope_boundary_surface
context_repair_reason: none
- `llamaindex`: status 200, latency 7614.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
  answer: Nos documentos internos consultados, a orientacao mais relevante aparece em Procedimento interno para pagamento parcial e negociacao:
Secao relevante: Procedimento interno para pagamento parcial e negociacao.
Quando a familia informa pagamento parcial, o financeiro deve registrar o valor pago, saldo pendente e canal de contato antes de propor negociacao. O sistema nao deve assumir quitacao total sem evidencia transacional.
[debug]
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_staff_finance_protocol:llamaindex
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 411.5ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_no_match`
  errors: missing_expected_keyword
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_staff_finance_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_finance_panorama:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_finance_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_finance_panorama:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_finance_panorama:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_docs_credentials:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_docs_credentials:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_docs_credentials:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_docs_credentials:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_denied:langgraph
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_denied:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_denied:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_student_academic_self:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_student_academic_self:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_student_academic_self:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_student_academic_self:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_pricing_projection:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_pricing_projection:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_pricing_projection:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_pricing_projection:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_access_scope:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_access_scope:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:finance > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_access_scope
context_repair_reason: none
- `llamaindex`: status 200, latency 643.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_access_scope`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:finance`
  answer: Voce ja esta autenticado por aqui e sua conta esta vinculada a Lucas Oliveira e Ana Oliveira. Por este canal eu consigo consultar notas, faltas, proximas provas, matricula, financeiro, boletos, dentro das permissoes dessa vinculacao.  Escopo atual:
- Lucas Oliveira: academico, financeiro
- Ana Oliveira: academico, financeiro Se quiser, me diga algo como "notas do Lucas", "faltas da Ana" ou "financeiro do Lucas".
[debug]
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_access_scope:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:finance > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_access_scope:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 1462.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_scope_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_scope_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_scope_protocol:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_restricted_scope_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
...
- `langgraph`: status 200, latency 2284.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_upcoming_assessments:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_upcoming_assessments:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `llamaindex`: status 200, latency 1613.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Proximas avaliacoes das contas vinculadas:
- Lucas Oliveira (1o Ano A)
- Biologia
- Trabalho B1: 2026-04-18
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_upcoming_assessments:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_upcoming_assessments:specialist_supervisor
ingress: none:none
...
- `langgraph`: status 200, latency 1868.0ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_attendance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_attendance_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `llamaindex`: status 200, latency 1186.9ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Panorama de frequencia das contas vinculadas:
- Lucas Oliveira: 6 falta(s), 7 atraso(s), 19 presenca(s), 370 minuto(s) de ausencia. Ponto mais sensivel: Biologia (1 falta(s), 0 atraso(s)).
- Ana Oliveira: 6 falta(s), 9 atraso(s), 17 presenca(s), 410 minuto(s) de ausencia. Ponto mais sensivel: Portugues (1 falta(s), 1 atraso(s)).
Quem exige maior atencao agora: Ana Oliveira. O ponto mais sensivel aparece em Portugues.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_attendance_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_attendance_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_protected_attendance_panorama` turn `1`
- `langgraph`: status 200, latency 10702.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_family_new_bundle:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_teacher_schedule_panorama:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_teacher_schedule_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 7043.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Resumo docente de Fernando Azevedo: 10 turma(s) e 6 disciplina(s) ativas nesta base. Disciplinas: Fisica, Quimica, Filosofia, Historia. Turmas: 1o Ano A, 1o Ano B, 2o Ano A, 2o Ano B. No uso do calendario publico da escola, priorize datas institucionais abertas a familias e equipe, como reunioes, simulados, conselhos e janelas letivas publicadas. Nos canais oficiais da escola, a secretaria continua sendo o contato institucional mais seguro para comunicacao geral; para alinhamentos pedagogicos, o fluxo correto passa por coordenacao e orientacao conforme o assunto.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_teacher_schedule_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_teacher_schedule_panorama:specialist_supervisor
ingress: none:none
...
- Slice: `protected`
- Thread: `retrieval_teacher_schedule_panorama` turn `1`
- `langgraph`: status 200, latency 7530.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `early_return`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `authenticated_public_profile_rescue`
...
answer_experience_reason: structured_grounded_answer:fallback_to_original
context_repair_reason: none
- `python_functions`: status 200, latency 7246.6ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `python_functions_native_teacher_schedule`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_teacher_schedule`
  errors: missing_expected_keyword
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 7325.7ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  errors: missing_expected_keyword
  answer: Grade docente de Fernando Azevedo:
- 1o Ano A - Fisica (2026)
- 1o Ano A - Quimica (2026)
...
- `langgraph`: status 200, latency 27797.1ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_service_routing`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_turn_frame:public_answer`
  errors: missing_expected_keyword
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_service_routing:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_service_routing:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > turn_frame:public.contacts.leadership > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier, public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_service_routing:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_service_routing:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_finance_combo:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_finance_combo:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_finance_combo:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_admin_finance_combo:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_governance_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_public_governance_protocol:llamaindex
ingress: unknown:none
...
- `langgraph`: status 200, latency 1647.7ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
  answer: Panorama academico das contas vinculadas:
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_family_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `python_functions`: status 200, latency 1290.8ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `python_functions_native_structured:academic`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_structured:academic`
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Biologia 7,9; Educacao Fisica 6,5; Filosofia 7,1; Fisica 5,9
- Ana Oliveira: Biologia 8,0; Educacao Fisica 7,0; Filosofia 7,5; Fisica 6,4 Quem hoje exige maior atencao academica e Lucas Oliveira, principalmente em Fisica.
[debug]
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_family_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 1164.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Biologia 7,9; Educacao Fisica 6,5; Filosofia 7,1; Fisica 5,9
- Ana Oliveira: Biologia 8,0; Educacao Fisica 7,0; Filosofia 7,5; Fisica 6,4 Quem hoje exige maior atencao academica e Lucas Oliveira, principalmente em Fisica.
[debug]
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_family_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 338.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:academic_summary_aggregate`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:academic_summary_aggregate`
  answer: Panorama academico das contas vinculadas:
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T074433Z:retrieval_protected_family_panorama:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > academic_summary_aggregate
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:protected_academic_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 1009.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Os pontos academicos que mais preocupam em Ana Oliveira hoje sao:
- Fisica: media parcial 6,4
- Educacao Fisica: media parcial 7,0
- Geografia: media parcial 7,0
