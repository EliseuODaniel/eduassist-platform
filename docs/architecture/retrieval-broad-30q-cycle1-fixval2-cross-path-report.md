...
Date: 2026-04-15T07:24:16.774231+00:00
...
| --- | --- | --- | --- | --- | --- |
| `langgraph` | `30/30` | `26/30` | `96.5` | `5498.5 ms` | `0/30` |
| `python_functions` | `30/30` | `23/30` | `93.9` | `5312.4 ms` | `0/30` |
| `llamaindex` | `30/30` | `23/30` | `91.5` | `6508.0 ms` | `8/30` |
| `specialist_supervisor` | `30/30` | `12/30` | `82.3` | `1075.0 ms` | `0/30` |

## By Slice

- `protected`
  - `langgraph`: ok 13/13, keyword pass 11/13, quality 95.1, latency 5410.5ms, final polish 0/13
  - `python_functions`: ok 13/13, keyword pass 10/13, quality 93.5, latency 4211.0ms, final polish 0/13
  - `llamaindex`: ok 13/13, keyword pass 11/13, quality 95.1, latency 3550.5ms, final polish 0/13
  - `specialist_supervisor`: ok 13/13, keyword pass 1/13, quality 75.1, latency 130.8ms, final polish 0/13
- `public`
  - `langgraph`: ok 11/11, keyword pass 9/11, quality 96.4, latency 7128.3ms, final polish 0/11
  - `python_functions`: ok 11/11, keyword pass 8/11, quality 92.7, latency 8177.7ms, final polish 0/11
  - `llamaindex`: ok 11/11, keyword pass 6/11, quality 82.7, latency 11531.9ms, final polish 8/11
  - `specialist_supervisor`: ok 11/11, keyword pass 6/11, quality 82.9, latency 2446.4ms, final polish 0/11
- `restricted`
  - `langgraph`: ok 6/6, keyword pass 6/6, quality 100.0, latency 2701.2ms, final polish 0/6
  - `python_functions`: ok 6/6, keyword pass 5/6, quality 96.7, latency 2445.4ms, final polish 0/6
  - `llamaindex`: ok 6/6, keyword pass 6/6, quality 100.0, latency 3705.7ms, final polish 0/6
  - `specialist_supervisor`: ok 6/6, keyword pass 5/6, quality 96.7, latency 606.7ms, final polish 0/6
...
- `llamaindex`: attendance_metric_misroute=1, forbidden_entity_or_value=2, missing_expected_keyword=6, weak_actionability=2
- `specialist_supervisor`: missing_expected_keyword=18, multi_intent_partial_collapse=5, partial_scope_loss=1, weak_actionability=2
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_no_match:langgraph
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_no_match:llamaindex
ingress: unknown:none
...
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_no_match:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_external_library_boundary:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_external_library_boundary:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_external_library_boundary:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_external_library_boundary:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_known_unknown_total_teachers:langgraph
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_known_unknown_total_teachers:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_facilities_study:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_facilities_study:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_facilities_study:llamaindex
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_docs:langgraph
ingress: unknown:none
...
context_repair_reason: none
- `python_functions`: status 200, latency 737.7ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `python_functions_prefers_deterministic`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_turn_frame:scope_boundary`
  errors: missing_expected_keyword
  answer: Nao tenho base confiavel aqui no EduAssist do Colegio Horizonte para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_docs:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_docs:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_docs:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_finance_playbook:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_finance_playbook:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_finance_playbook:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_finance_playbook:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_teacher_directory:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_teacher_directory:python_functions
ingress: unknown:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_open_world_out_of_scope:langgraph
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_scope_boundary_surface
context_repair_reason: none
- `python_functions`: status 200, latency 440.8ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `turn_frame_classifier`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `python_functions_prefers_deterministic`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_scope_boundary_surface`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `deterministic_candidate_selected`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_turn_frame:scope_boundary`
  answer: Nao tenho base confiavel aqui no EduAssist do Colegio Horizonte para responder esse tema fora do escopo da escola. Se quiser, eu posso ajudar com matricula, calendario, regras publicas, visitas, notas, frequencia ou financeiro.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_open_world_out_of_scope:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:unknown > mode:clarify > turn_frame:scope_boundary > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_open_world_out_of_scope:llamaindex
ingress: unknown:none
...
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 108.4ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_open_world_out_of_scope:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_boundary_auth_needed:langgraph
ingress: unknown:none
...
context_repair_reason: none
- `python_functions`: status 200, latency 9629.0ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `context_repair_planner, retrieval_retry_answer`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `mode_not_polishable`, answer_experience_applied `True`, answer_experience_reason `context_repair:second_retrieval_retry`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_local_clarify`
  errors: missing_expected_keyword
  answer: Para consultar seu boletim, é necessário estar autenticado. As informações acadêmicas pessoais, como notas e frequência, são consideradas dados protegidos e só podem ser acessadas após você realizar o login no sistema. Posso ajudar com informações públicas sobre a escola, como o calendário escolar, documentos necessários para matrícula ou regras gerais de atendimento.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_boundary_auth_needed:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_boundary_auth_needed:llamaindex
ingress: unknown:none
...
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 89.8ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_boundary_auth_needed:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_teacher_manual:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_teacher_manual:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 818.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_no_match`
  answer: Consultei os documentos internos disponiveis, mas nao encontrei uma orientacao restrita especifica para: "Sem sair do escopo do projeto, pelo manual interno do professor, qual e a regra para registro de avaliacoes e comunicacao com foco pedagogico". Na pratica, esta base nao trouxe detalhe interno suficiente para responder com seguranca; o proximo passo e consultar o setor responsavel ou pedir apenas o material publico correspondente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_teacher_manual:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_teacher_manual:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_discipline_recovery:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_discipline_recovery:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_discipline_recovery:llamaindex
ingress: unknown:none
...
- `langgraph`: status 200, latency 2822.3ms, keyword pass `True`, quality `100`, used_llm `True`, llm_stages `grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
  answer: Para qualquer negociação financeira, especialmente quando se trata de pagamentos parciais, o procedimento interno estabelece que o financeiro deve registrar o valor pago, o saldo pendente e o canal de contato da família antes de propor qualquer negociação. É fundamental que o sistema não assuma uma quitação total sem ter a devida evidência transacional.
[debug]
stack: langgraph
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_staff_finance_protocol:langgraph
ingress: unknown:none
...
context_repair_reason: none
- `python_functions`: status 200, latency 1775.8ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `turn_frame_classifier, grounded_answer_experience`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `contextual_public_direct_answer`
  errors: missing_expected_keyword
  answer: Não tenho informações detalhadas sobre os procedimentos internos de negociação financeira, como as validações que antecedem uma promessa de quitação. Posso ajudar com informações sobre matrícula, calendário escolar, regras públicas, visitas ou outros assuntos gerais da escola.
[debug]
stack: python_functions
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_staff_finance_protocol:python_functions
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer
context_repair_reason: none
- `llamaindex`: status 200, latency 7303.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_staff_finance_protocol:llamaindex
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 273.9ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_tool_first:restricted_document_no_match`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_tool_first:restricted_document_no_match`
  errors: missing_expected_keyword
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_staff_finance_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_no_match
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_finance_panorama:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_finance_panorama:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_finance_panorama:llamaindex
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:protected_finance_direct
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 107.1ms, keyword pass `False`, quality `70`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_finance_panorama:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_docs_credentials:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_docs_credentials:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_docs_credentials:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_docs_credentials:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_denied:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_denied:python_functions
ingress: unknown:none
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 422.2ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_access_deny`
  answer: Nao posso compartilhar procedimentos, protocolos, manuais ou playbooks internos da escola por este canal, porque este perfil nao tem acesso a esse material restrito. Se quiser, eu posso orientar pelo material publico correspondente.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_denied:llamaindex
ingress: unknown:none
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_denied:specialist_supervisor
ingress: none:none
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_student_academic_self:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_student_academic_self:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_student_academic_self:llamaindex
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 98.5ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_student_academic_self:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_pricing_projection:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_pricing_projection:python_functions
ingress: unknown:none
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_pricing_projection:llamaindex
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_pricing_projection
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 12352.1ms, keyword pass `False`, quality `54`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_pricing_projection:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_access_scope:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_access_scope:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:finance > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_access_scope:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:finance > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_access_scope
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 116.5ms, keyword pass `False`, quality `54`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword, multi_intent_partial_collapse
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_access_scope:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
- `langgraph`: status 200, latency 1196.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `langgraph_restricted_doc_grounded`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_scope_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call > turn_frame:protected.documents.restricted_lookup > langgraph_response_workflow > restricted_retrieval
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_scope_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > turn_frame:protected.documents.restricted_lookup > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier)
final_polish: skip
...
answer_experience_reason: none
context_repair_reason: none
- `llamaindex`: status 200, latency 1052.5ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `none`, final_polish_reason `none`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_restricted_doc_fast_path`
  answer: Para o pedido sobre limites de acesso no Telegram para responsaveis com escopo parcial, o protocolo interno mais relevante e este:
Nos documentos internos consultados, a orientacao mais relevante aparece em Protocolo interno para responsaveis com escopo parcial:
Secao relevante: Protocolo interno para responsaveis com escopo parcial.
Responsaveis com escopo parcial exigem validacao cuidadosa para evitar vazamento de dados. A equipe deve conferir se o vinculo vigente concede acesso academico, financeiro ou ambos.
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_scope_protocol:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:support > mode:hybrid_retrieval > turn_frame:protected.documents.restricted_lookup > llamaindex:restricted > llamaindex:restricted_doc_fast_path > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_restricted_scope_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > tool_first > restricted_document_search
llm: no
final_polish: skip
...
- `langgraph`: status 200, latency 2175.1ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_upcoming_assessments:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_upcoming_assessments:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `llamaindex`: status 200, latency 1507.0ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Proximas avaliacoes das contas vinculadas:
- Lucas Oliveira (1o Ano A)
- Biologia
- Trabalho B1: 2026-04-18
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_upcoming_assessments:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 98.1ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_upcoming_assessments:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
- `langgraph`: status 200, latency 1239.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:preserve_family_aggregate`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_attendance_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_attendance_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_attendance_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:preserve_family_aggregate
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 86.9ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_attendance_panorama:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
- Slice: `protected`
- Thread: `retrieval_protected_attendance_panorama` turn `1`
- `langgraph`: status 200, latency 14788.3ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 127.7ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_family_new_bundle:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_teacher_schedule_panorama:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_teacher_schedule_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 6815.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Resumo docente de Fernando Azevedo: 10 turma(s) e 6 disciplina(s) ativas nesta base. Disciplinas: Fisica, Quimica, Filosofia, Historia. Turmas: 1o Ano A, 1o Ano B, 2o Ano A, 2o Ano B. No uso do calendario publico da escola, priorize datas institucionais abertas a familias e equipe, como reunioes, simulados, conselhos e janelas letivas publicadas. Nos canais oficiais da escola, a secretaria continua sendo o contato institucional mais seguro para comunicacao geral; para alinhamentos pedagogicos, o fluxo correto passa por coordenacao e orientacao conforme o assunto.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_teacher_schedule_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_teacher_schedule_panorama:specialist_supervisor
ingress: none:none
...
answer_experience_reason: structured_grounded_answer:fallback_to_original
context_repair_reason: none
- `python_functions`: status 200, latency 6695.6ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `python_functions_native_teacher_schedule`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_teacher_schedule`
  errors: missing_expected_keyword
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `llamaindex`: status 200, latency 6867.0ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `False`, answer_experience_reason `protected_grounded_answer:fallback_to_original`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  errors: missing_expected_keyword
  answer: Grade docente de Fernando Azevedo:
- 1o Ano A - Fisica (2026)
- 1o Ano A - Quimica (2026)
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 283.5ms, keyword pass `False`, quality `80`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `quality_first_path`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_fast_path:teacher_schedule`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_fast_path:teacher_schedule`
  errors: missing_expected_keyword
  answer: Grade docente de Fernando Azevedo:
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_service_routing:langgraph
ingress: unknown:none
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_service_routing:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > turn_frame:public.contacts.leadership > python_functions:native_runtime > kernel:python_functions
llm: yes (turn_frame_classifier, public_answer_composer)
final_polish: skip
...
answer_experience_reason: structured_grounded_answer:preserve_service_routing
context_repair_reason: none
- `llamaindex`: status 200, latency 25195.2ms, keyword pass `False`, quality `80`, used_llm `True`, llm_stages `public_answer_composer`, final_polish_applied `True`, final_polish_mode `grounded_public_composition`, final_polish_reason `public_answer_composer`, answer_experience_applied `False`, answer_experience_reason `structured_grounded_answer:preserve_service_routing`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `contextual_public_direct_fast_path`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_contextual_public_direct_fast_path`
  errors: missing_expected_keyword
  answer: Para assuntos de bolsas e matrícula, você pode usar o canal bot, WhatsApp comercial ou visitar a escola. Para a secretaria, utilize o canal bot, secretaria presencial, e-mail institucional ou portal. Para a direção, o contato direto é por e-mail: direcao@colegiohorizonte.edu.br.
[debug]
stack: llamaindex
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_service_routing:llamaindex
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_service_routing
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 13393.5ms, keyword pass `False`, quality `54`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword, multi_intent_partial_collapse
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_service_routing:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_finance_combo:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_finance_combo:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_finance_combo:llamaindex
ingress: unknown:none
...
answer_experience_reason: protected_grounded_answer:fallback_to_original
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 107.1ms, keyword pass `False`, quality `54`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword, multi_intent_partial_collapse
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_admin_finance_combo:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_governance_protocol:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > public_slice > structured_tool_call
llm: no
final_polish: skip
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_governance_protocol:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:institution > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: yes (public_answer_composer)
final_polish: skip
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_governance_protocol:llamaindex
ingress: unknown:none
...
answer_experience_reason: structured_grounded_answer:preserve_public_canonical_lane
context_repair_reason: none
- `specialist_supervisor`: status 200, latency 90.9ms, keyword pass `False`, quality `44`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `request_failed_fallback`, answer_experience_applied `False`, answer_experience_reason `none`, answer_experience_provider `none`, answer_experience_model `none`, candidate `specialist_supervisor`, candidate_reason `specialist_supervisor_request_failed_fallback`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `specialist_supervisor_request_failed_fallback`
  errors: missing_expected_keyword, multi_intent_partial_collapse, weak_actionability
  answer: Tive uma falha interna ao tentar montar essa resposta. Para nao te devolver algo inconsistente, fiquei no fallback seguro: posso responder apenas o que estiver sustentado no material publico ou reabrir a pergunta em um recorte mais especifico.
[debug]
stack: specialist_supervisor
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_public_governance_protocol:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
- `langgraph`: status 200, latency 1266.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `deterministic_answer`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `dados estruturados devem passar por service deterministico`
...
bundle: langgraph
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_family_panorama:langgraph
ingress: unknown:none
path: langgraph > classify_request > security_gate > route_request > select_slice > protected_slice > structured_tool_call
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `python_functions`: status 200, latency 1002.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `deterministic`, candidate_reason `python_functions_native_structured:academic`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `python_functions_native_structured:academic`
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Biologia 7,9; Educacao Fisica 6,5; Filosofia 7,1; Fisica 5,9
- Ana Oliveira: Biologia 8,0; Educacao Fisica 7,0; Filosofia 7,5; Fisica 6,4 Quem hoje exige maior atencao academica e Lucas Oliveira, principalmente em Fisica.
[debug]
...
bundle: python_functions
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_family_panorama:python_functions
ingress: unknown:none
path: python_functions > python_functions:planner > domain:academic > mode:structured_tool > python_functions:native_runtime > kernel:python_functions
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:supplemental_focus_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 1287.6ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:supplemental_focus_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Panorama academico das contas vinculadas:
- Lucas Oliveira: Biologia 7,9; Educacao Fisica 6,5; Filosofia 7,1; Fisica 5,9
- Ana Oliveira: Biologia 8,0; Educacao Fisica 7,0; Filosofia 7,5; Fisica 6,4 Quem hoje exige maior atencao academica e Lucas Oliveira, principalmente em Fisica.
[debug]
...
bundle: llamaindex
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_family_panorama:llamaindex
ingress: unknown:none
path: llamaindex > llamaindex:planner > domain:academic > mode:structured_tool > kernel:llamaindex
llm: no
final_polish: skip
...
bundle: specialist_supervisor
corr: none
conversation: debug:four-path:normal:20260415T071504Z:retrieval_protected_family_panorama:specialist_supervisor
ingress: none:none
path: specialist_supervisor > fallback > request_failed
llm: no
final_polish: skip
...
answer_experience_reason: protected_grounded_answer:protected_academic_direct
context_repair_reason: none
- `llamaindex`: status 200, latency 905.4ms, keyword pass `True`, quality `100`, used_llm `False`, llm_stages `none`, final_polish_applied `False`, final_polish_mode `skip`, final_polish_reason `sensitive_surface`, answer_experience_applied `True`, answer_experience_reason `protected_grounded_answer:protected_academic_direct`, answer_experience_provider `openai`, answer_experience_model `ggml-org/gemma-4-E4B-it-GGUF:Q4_K_M`, candidate `none`, candidate_reason `none`, probe_topic `none`, cache_hit `False`, cache_kind `none`, reason `llamaindex_local_protected:academic`
  answer: Os pontos academicos que mais preocupam em Ana Oliveira hoje sao:
- Fisica: media parcial 6,4
- Educacao Fisica: media parcial 7,0
- Geografia: media parcial 7,0
