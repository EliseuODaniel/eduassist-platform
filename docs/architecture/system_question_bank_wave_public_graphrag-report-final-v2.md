...
| `crewai` | `8/8` | `8/8` | `100.0` | `12122.3 ms` |
...
- `public`
  ...
  - `crewai`: ok 8/8, keyword pass 8/8, quality 100.0, latency 12122.3ms
...
- `crewai`: status 200, latency 265.5ms, keyword pass `True`, quality `100`, reason `crewai_public_fast_path`
...
- `crewai`: status 200, latency 15122.7ms, keyword pass `True`, quality `100`, reason `crewai_primary_strict_safe_fallback`
...
- `crewai`: status 200, latency 131.2ms, keyword pass `True`, quality `100`, reason `crewai_public_fast_path`
...
- `crewai`: status 200, latency 20132.7ms, keyword pass `True`, quality `100`, reason `crewai_primary_strict_safe_fallback`
...
- `crewai`: status 200, latency 15122.9ms, keyword pass `True`, quality `100`, reason `crewai_primary_strict_safe_fallback`
  answer: Nao consegui concluir essa resposta agora pelo caminho principal configurado. Tente reformular em uma frase mais direta ou repetir em instantes.
...
- `crewai`: status 200, latency 15122.6ms, keyword pass `True`, quality `100`, reason `crewai_primary_strict_safe_fallback`
  answer: Nao consegui concluir essa resposta agora pelo caminho principal configurado. Tente reformular em uma frase mais direta ou repetir em instantes.
...
- `crewai`: status 200, latency 951.4ms, keyword pass `True`, quality `100`, reason `crewai_public_fast_path`
...
- `crewai`: status 200, latency 30129.3ms, keyword pass `True`, quality `100`, reason `crewai_primary_strict_safe_fallback`
  answer: Nao consegui concluir essa resposta agora pelo caminho principal configurado. Tente reformular em uma frase mais direta ou repetir em instantes.
