...
- `tools/graphrag-benchmark` prepara um workspace opt-in para benchmark seletivo de `GraphRAG` sobre o corpus institucional publico, com bootstrap, dataset de perguntas, preflight local e runner comparativo contra o baseline hibrido;
