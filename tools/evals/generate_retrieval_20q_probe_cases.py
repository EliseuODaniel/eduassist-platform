...
QUESTION_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        "category": "public_section_aware",
        "slice": "public",
        "expected_keywords": ["biblioteca", "laborator", "estudo orientado"],
        "forbidden_keywords": ["Lucas Oliveira", "Ana Oliveira"],
        "thread_id": "retrieval_public_facilities_actionable_path",
        "telegram_chat_id": 777240,
        "note": "public actionable facilities/study support synthesis",
        "user": {"role": "anonymous", "authenticated": False, "linked_student_ids": [], "scopes": []},
        "prompts": [
            "Na pratica, como a familia deve usar biblioteca, laboratorios e estudo orientado sem se perder?",
            "Sem resumao generico: como a familia decide entre biblioteca, laboratorios e estudo orientado no dia a dia?",
            "Quero um uso pratico de biblioteca, laboratorios e estudo orientado para a familia nao se enrolar.",
    ...
    },
    {
        "category": "public_permanence_support",
        "slice": "public",
        "expected_keywords": ["familia", "frequencia", "apoio"],
        "forbidden_keywords": ["Lucas Oliveira", "Ana Oliveira"],
        "thread_id": "retrieval_public_permanence_actionable_path",
        "telegram_chat_id": 777241,
        "note": "public actionable permanence/family support synthesis",
        "user": {"role": "anonymous", "authenticated": False, "linked_student_ids": [], "scopes": []},
        "prompts": [
            "Na pratica, como a familia acompanha permanencia escolar e o que fazer primeiro quando surgem sinais de risco?",
            "Quero uma resposta concreta: como a familia acompanha permanencia escolar e qual e o primeiro passo diante de sinais de risco?",
            "Sem sair do material publico, qual e a ordem pratica para a familia acompanhar permanencia escolar e agir ao primeiro sinal de risco?",
    ...
    },
    {
        "category": "protected_structured_attendance_detail",
        "slice": "protected",
        "expected_keywords": ["Lucas Oliveira", "frequencia", "alerta"],
        "forbidden_keywords": ["Ana Oliveira"],
        "thread_id": "retrieval_protected_attendance_component_pressure",
        "telegram_chat_id": 1649845499,
        "note": "protected attendance component pressure wording",
        "user": {
            "role": "guardian",
            "authenticated": True,
            "linked_student_ids": ["stu-lucas", "stu-ana"],
        ...
        "prompts": [
            "Quero ver o ponto mais critico da frequencia do Lucas e em quais componentes as ausencias pesam mais.",
            "No Lucas, em quais componentes as ausencias mais pesam hoje e qual e o principal alerta de frequencia?",
            "Recorte o Lucas e diga onde as ausencias dele mais pressionam a frequencia agora.",
            "Qual e hoje o principal alerta de frequencia do Lucas e em quais componentes isso pesa mais?",
        ],
    },
    {
        "category": "protected_structured_attendance_followup",
        "slice": "protected",
        "expected_keywords": ["Lucas Oliveira", "proximo passo"],
        "forbidden_keywords": ["Ana Oliveira"],
        "thread_id": "retrieval_protected_attendance_next_step_singleton",
        "telegram_chat_id": 1649845499,
        "note": "protected attendance next-step singleton phrasing",
        "user": {
            "role": "guardian",
            "authenticated": True,
            "linked_student_ids": ["stu-lucas", "stu-ana"],
        ...
        "prompts": [
            "Sem repetir todo o quadro, qual e o proximo passo mais util olhando a frequencia do Lucas?",
            "Olhando frequencia e faltas do Lucas, o que eu deveria acompanhar primeiro agora?",
            "Sem me devolver o panorama inteiro, qual e o proximo passo mais importante na frequencia do Lucas?",
            "Se eu quiser agir logo, qual e o primeiro acompanhamento recomendado na frequencia do Lucas?",
        ],
    },
    {
        "category": "restricted_doc_positive_scope_protocol_variant",
        ...
        "expected_keywords": ["telegram", "escopo"],
        "forbidden_keywords": ["nao posso compartilhar"],
        "thread_id": "retrieval_restricted_scope_protocol_longform",
        "telegram_chat_id": 1649845499,
        "note": "restricted positive protocol variant with long-form wording",
        "user": {
            "role": "guardian",
            "authenticated": True,
            "linked_student_ids": ["stu-lucas", "stu-ana"],
        ...
        "prompts": [
            "Quero o protocolo interno do Telegram com escopo parcial para responsaveis e limites de acesso.",
            "Nos documentos internos, como o Telegram deve operar quando o responsavel tem escopo parcial e tenta ir alem do acesso permitido?",
            "Pelo protocolo interno, quais limites de acesso e de resposta o Telegram precisa respeitar no escopo parcial do responsavel?",
    ...
    },
    {
        "category": "restricted_doc_positive_teacher_feedback",
        "slice": "restricted",
        "expected_keywords": ["professor", "devolutiva"],
        "forbidden_keywords": ["nao posso compartilhar"],
        "thread_id": "retrieval_restricted_teacher_feedback_longform",
        "telegram_chat_id": 1649845499,
        "note": "restricted teacher feedback long-form query variants",
        "user": {
            "role": "guardian",
            "authenticated": True,
            "linked_student_ids": ["stu-lucas", "stu-ana"],
        ...
        "prompts": [
            "No manual interno do professor, o que aparece sobre comunicacao pedagogica, devolutiva e registro de avaliacao ao estudante?",
            "Quero a orientacao interna do professor sobre devolutiva pedagogica, registro avaliativo e comunicacao com o estudante.",
            ...
            "No material interno do professor, como ficam devolutiva, registro de avaliacao e comunicacao pedagogica com o estudante?",
        ],
    },
    {
        "category": "public_visibility_boundary",
        "slice": "public",
        "expected_keywords": ["escola", "public"],
        "forbidden_keywords": ["Biblioteca Aurora"],
        "thread_id": "retrieval_public_external_library_boundary",
        "telegram_chat_id": 777242,
        "note": "public boundary for external city library question",
        "user": {"role": "anonymous", "authenticated": False, "linked_student_ids": [], "scopes": []},
        "prompts": [
            "Qual horario de fechamento da biblioteca publica da cidade?",
            "A biblioteca publica da cidade fecha que horas? Se isso fugir da escola, diga claramente.",
            "Quero o horario da biblioteca publica da cidade, nao da escola.",
