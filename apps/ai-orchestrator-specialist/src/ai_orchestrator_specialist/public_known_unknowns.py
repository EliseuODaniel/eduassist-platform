    ...
    *,
    ...
    if key == 'minimum_age':
        return (
            ...
            'O que aparece oficialmente sao os segmentos atendidos e o enquadramento por serie; para confirmar idade e adequacao de ingresso, o canal certo e admissions, matricula e atendimento comercial.'
        )
