...
class RetrievalService:
    ...
    def hybrid_search(
            ...
            *,
            ...
            from .local_retrieval_search_runtime import hybrid_search_impl
    ...
    def _lexical_search(
            ...
            *,
            ...
            from .local_retrieval_search_runtime import lexical_search_impl

            return lexical_search_impl(
                self,
                query=query,
                top_k=top_k,
                visibility=visibility,
    ...
    def _fuse_hits(
            ...
            *,
            ...
            from .local_retrieval_search_runtime import fuse_hits_impl

            return fuse_hits_impl(
                self,
