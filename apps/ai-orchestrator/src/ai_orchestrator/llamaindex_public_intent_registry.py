...
LLAMAINDEX_PUBLIC_INTENT_RULES: tuple[LlamaIndexPublicIntentRule, ...] = (
    ...
    LlamaIndexPublicIntentRule(
        ...
        answer_mode='profile',
        any_of=('documentos sao exigidos', 'envio de documentos', 'atualizacoes cadastrais', 'declarações', 'declaracoes'),
    ...
    LlamaIndexPublicIntentRule(
        ...
        answer_mode='profile',
        any_of=('abre a matricula de 2026', 'abre a matrícula de 2026', 'quando comecam as aulas', 'quando começam as aulas'),
        all_of=('matricula', 'aulas'),
