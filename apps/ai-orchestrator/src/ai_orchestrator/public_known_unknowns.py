...
_RULES: tuple[PublicKnownUnknownRule, ...] = (
    PublicKnownUnknownRule(
        key='total_students',
        triggers=('quantos alunos', 'quantidade de alunos', 'numero de alunos', 'número de alunos'),
    ),
    PublicKnownUnknownRule(
        key='total_teachers',
        triggers=('quantos professores', 'quantidade de professores', 'numero de professores', 'número de professores'),
    ),
    PublicKnownUnknownRule(
        key='classroom_count',
        triggers=('quantas salas', 'quantidade de salas', 'numero de salas', 'número de salas'),
    ),
    PublicKnownUnknownRule(
        key='library_book_count',
        triggers=('quantos livros', 'quantidade de livros', 'numero de livros', 'número de livros'),
