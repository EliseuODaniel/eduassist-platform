...
- `tools/ops/backup_local_stack.sh`: backup local de Postgres e MinIO
- `tools/ops/verify_local_backup.sh`: drill seguro de restore em banco e bucket temporários
