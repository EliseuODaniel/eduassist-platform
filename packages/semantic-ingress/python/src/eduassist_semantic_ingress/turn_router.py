...
_CAPABILITY_SPECS: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec(
        ...
        access_tier="public",
        scope="public",
        description="informar feriados e eventos públicos do calendário escolar",
        aliases=(
            "quais os feriados desse ano",
            "quais sao os feriados desse ano",
            "quais são os feriados desse ano",
            "feriados desse ano",
            "feriados deste ano",
            "quais os feriados do ano",
            "quais sao os feriados do ano",
            "quais são os feriados do ano",
            "feriados do ano",
            "feriados da escola",
            "calendario de feriados",
            "calendário de feriados",
            "quais os feriados",
            "quais sao os feriados",
            "quais são os feriados",
        ),
        public_conversation_act="calendar_events",
        public_focus_hint="feriados",
