...
def _build_sections(
    *,
    ...
    instructions = (
        ...
        "Quando a pergunta pedir mais de uma frente, setor, canal ou responsabilidade ao mesmo tempo, preserve explicitamente cada frente pedida na resposta final se a evidencia sustentar isso. "
        "Nao elimine um setor nomeado pelo usuario so para deixar a resposta mais curta. "
        "Se a pergunta citar, por exemplo, admissoes, financeiro e direcao, a resposta final precisa contemplar os tres, ainda que em formato compacto. "
        ...
        "Quando a pergunta trouxer qualificadores explicitos como 'por mes', 'por mês', 'por aluno', 'abertura', 'fechamento' ou 'primeiro/depois', "
        "preserve esses qualificadores na resposta final em vez de parafrasea-los para algo mais vago. "
        "Quando a pergunta pedir ordem, passo a passo, distribuicao temporal, comparacao pratica, forma concreta ou como a familia deve agir, "
        "sintetize a resposta em sequencia operacional curta e grounded, usando marcadores como 'primeiro', 'depois' e 'por fim' quando isso ajudar. "
        "Nao pare em um resumo generico se a evidencia permitir orientar o uso pratico da informacao. "
        "Se a evidencia sustentar um proximo passo institucional claro, inclua esse proximo passo em uma frase curta. "
        "Responda em portugues do Brasil, com tom humano, direto e natural. "
        "Prefira 1 a 3 frases curtas. Se a pergunta pedir varias frentes ao mesmo tempo, uma lista curta de 2 a 4 marcadores tambem e aceitavel. "
